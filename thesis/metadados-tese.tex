...
\tituloport{Visualização Dinâmica Multi-Escala de Dados do Tráfego de Veículos}

% Se "\title" está em português, você pode definir o título em inglês aqui
\tituloeng{Dynamic Multi Scale Visualization of Simulated Traffic Data}
...
\coorientador[masc]{Prof. Dr. Paulo Meirelles}
...
financeiro da Universidade de São Paulo}
